...
var (
	...
	// module accounts that are allowed to receive coinswaps
...
func NewSimApp(
	...
	app.mm.SetOrderBeginBlockers(
		...
		evidencetypes.ModuleName, stakingtypes.ModuleName, ibchost.ModuleName, coinswaptypes.ModuleName,
	)
	app.mm.SetOrderEndBlockers(crisistypes.ModuleName, govtypes.ModuleName, stakingtypes.ModuleName)

	// NOTE: The genutils moodule must occur after staking so that pools are
	// properly initialized with coinswaps from genesis accounts.
...
// allowed to receive external coinswaps.
